...
public abstract class ModLangProvider extends LanguageProvider {
    ...
    public static class English extends ModLangProvider {
        ...
        protected void addTranslations() {
            ...
            addAdvancement("ride_scarf_luo", "No Saddle Needed", "Ride an adult Scarf Luo as its owner.");
            addAdvancement("rider_attack", "Target Acquired", "While riding a Scarf Luo, attack a target and fire a three-shot burst together.");
            ...
            addAdvancement("smoke_luanluan", "Processed Luanluan", "Process a Tiansuluo Luanluan into Xiami Huhu using a furnace, smoker, or campfire.");
    ...
    public static class Chinese extends ModLangProvider {
        ...
        protected void addTranslations() {
            ...
            addAdvancement("ride_scarf_luo", "不用鞍也能骑", "作为主人骑乘一只成年围巾罗。");
            addAdvancement("rider_attack", "准星齐射", "骑乘围巾罗攻击目标，让它一起发射三发投射物。");
            ...
            addAdvancement("smoke_luanluan", "加工栾栾", "使用熔炉、烟熏炉或营火将天素罗栾栾加工成虾米糊糊。");
